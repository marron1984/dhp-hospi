...
export const fragmentShader = `
  ...
  void main() {
    ...
    // Pure white base with subtle depth
    vec3 baseColor = uColor;
    vec3 softTint = uColor * 0.95;
    vec3 finalColor = mix(softTint, baseColor, 0.5 + 0.5 * noise1);
