...
const galleryImages = [
  {
    ...
    aspect: "portrait",
    label: "Entrance",
    bg: "linear-gradient(135deg, #2A1A1A 0%, #1A0A0A 100%)",
  },
  {
    id: 2,
    aspect: "landscape",
    label: "Guest Room",
    bg: "linear-gradient(135deg, #1A1A2A 0%, #0A0A1A 100%)",
  },
  {
    id: 3,
    aspect: "square",
  ...
  },
  {
    ...
    aspect: "landscape",
    label: "Dining",
    bg: "linear-gradient(135deg, #2A2A1A 0%, #1A1A0A 100%)",
  },
  {
    id: 5,
    aspect: "portrait",
    label: "Onsen",
    bg: "linear-gradient(135deg, #1A2A2A 0%, #0A1A1A 100%)",
  },
];
...
export default function PortfolioGallery() {
  ...
  return (
    <section ref={sectionRef} className="relative overflow-hidden bg-obsidian-mid/30">
      {/* Header */}
      <div className="absolute top-0 left-0 right-0 z-10 pt-20 md:pt-32">
        <div ref={headerRef} className="container-dhp opacity-0">
          ...
          <h2 className="heading-display heading-lg mt-4 text-pearl">
            {t("title")}
          </h2>
          ...
          {galleryImages.map((img) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-black/60 via-transparent to-transparent p-6">
                ...
                <span className="heading-display heading-sm text-pearl mt-1">
                  {img.label}
                </span>
              </div>
            </div>
          ...
          <div className="flex h-[65vh] w-[40vw] shrink-0 flex-col justify-center px-8 md:w-[30vw]">
            ...
            >
              ...
              <svg
                ...
                viewBox="0 0 20 6"
                fill="none"
                className="text-imperial transition-transform duration-500 group-hover:translate-x-2"
              >
                <path
        ...
        <div className="container-dhp">
          ...
          >
            <div className="flex flex-col gap-3 border-b border-neutral-800/50 p-8 md:border-b-0 md:border-r">
              ...
              <h4 className="heading-sm text-pearl">{t("heritage")}</h4>
            </div>
            <div className="flex flex-col gap-3 border-b border-neutral-800/50 p-8 md:border-b-0 md:border-r">
              <svg
                width="24"
              ...
              <h4 className="heading-sm text-pearl">{t("architecture")}</h4>
            </div>
            <div className="flex flex-col gap-3 p-8">
              ...
              <h4 className="heading-sm text-pearl">{t("experience")}</h4>
            </div>
          </div>
        </div>
      </div>
